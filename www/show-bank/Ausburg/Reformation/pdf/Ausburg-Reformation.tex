...
\\ \\
{\bf Invoice To:} \\ % From here --->\dotfill \textsc{Show:} Ausburg\dotfill \textsc{Set:} Reformation\dotfill \textsc{Ordered by:} Luther
\tab {\bf Pickup Date:} \today \dotfill{\bf {Rental Period:}
\begin{invoiceTable}
\unitrow{Snake}{1}{1}{1/17}
\unitrow{Chair}{1}{1}{1/17}
\end{invoiceTable}
