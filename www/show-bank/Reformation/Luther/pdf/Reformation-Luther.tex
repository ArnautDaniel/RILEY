...
\\ \\
{\bf Invoice To:} \\ % From here --->\dotfill \textsc{Show:} Reformation\dotfill \textsc{Set:} Luther\dotfill \textsc{Ordered by:} Augsburg
\tab {\bf Pickup Date:} \today \dotfill{\bf {Rental Period:}
\begin{invoiceTable}
\unitrow{THE HELL IS GOING ON HERE}{1}{1}{1/17}
\unitrow{WHITE}{2}{2}{1/17}
\end{invoiceTable}
